...
public class VerificationCodePage extends AppCompatActivity {
    ...
    TextView backToConnection,mailNumberverif,resend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mailNumberverif=findViewById(R.id.mailnumberverif);
        ...
        backToConnection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent  =new Intent(VerificationCodePage.this,Connexion.class);
        ...
        n4.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                Intent intent  =new Intent(VerificationCodePage.this,NextSignUp.class);
                startActivity(intent);
