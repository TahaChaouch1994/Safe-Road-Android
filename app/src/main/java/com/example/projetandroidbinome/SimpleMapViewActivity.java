 ...
 */
public class SimpleMapViewActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
...
// Set the component's render mode
    ...
    private static class MainActivityLocationCallback
        ...
        private final WeakReference<SimpleMapViewActivity> activityWeakReference;

        MainActivityLocationCallback(SimpleMapViewActivity activity) {
        ...
        public void onSuccess(LocationEngineResult result) {
            SimpleMapViewActivity activity = activityWeakReference.get();
...
// Prevent leaks
    ...
    public static void displayPromptForEnablingGPS(final SimpleMapViewActivity activity)
    {
